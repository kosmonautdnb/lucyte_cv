...
Lucyte is not yet fast even with OpenCL. However, most feature tracking tasks can take larger time steps and be executed on dedicated hardware in parallel.
